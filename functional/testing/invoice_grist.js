...
// this function adds placeholder data to the invoice - therefore it's not critical
...
// this appears to be all the data that Vue will output
const data = {
  count: 0,
  invoice: '',
  status: 'waiting',
...
ready(function() {
  ...
  grist.on('message', msg => {
    /* If we are told about a table but not which row to access, check the number of rows. Currently if the table is empty, and "select by" is not set, onRecord() will never be called. */
